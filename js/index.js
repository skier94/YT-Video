const API_KEY = "AIzaSyAqbOv1EPfcO-SE-PdHPzZ5EsVc4v8kcHA";
...
const convertISOToReableDuration = (isoDuration) => {
...
const displayListVideo = (videos) => {
  ...
  const listVideos = videos.items.map((video) => {
    ...
    <a href="/video.html?id=${video.id}" class="video-card__link">
      ...
      }" alt="Превью ${video.snippet.title}">

      <h3 class="video-card__title">${video.snippet.title}</h3>

      <p class="video-card__channel">${video.snippet.channelTitle}</p>

      <p class="video-card__duration">${convertISOToReableDuration(
        ...
        <div class="video__container">
          <div class="video__content">
            ...
            <p class="video__info">
              ...
              ).toLocaleString()} просмотры</span>
              <span class="video__date">Дата премьеры: ${formateDate(
          ...
          <button class="video__link favorite ${
            ...
            <span class="vidio__no-favorite">Избранное</span>
            <span class="vidio__favorite">В избранном</span>
...
const init = () => {
  ...
  const searchQuary = urlSearchParams.get("q");
  ...
  } else if (currentPage === "search.html" && searchQuary) {
